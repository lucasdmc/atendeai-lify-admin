...
import { AgendamentosSidebar } from '@/components/agendamentos/AgendamentosSidebar';
        ...
        <SidebarInset>
          ...
          <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600">Gerencie agendamentos integrados com Google Calendar</p>
              </div>
