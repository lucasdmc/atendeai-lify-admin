  ...
  public: {
    Tables: {
      ...
      agent_whatsapp_connections: {
        ...
        Relationships: [
          {
            foreignKeyName: "agent_whatsapp_connections_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "agents"
            referencedColumns: ["id"]
      ...
      agent_whatsapp_conversations: {
        ...
        Relationships: [
          {
            foreignKeyName: "agent_whatsapp_conversations_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "agents"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "agent_whatsapp_conversations_connection_id_fkey"
            columns: ["connection_id"]
            isOneToOne: false
            referencedRelation: "agent_whatsapp_connections"
            referencedColumns: ["id"]
          },
        ]
      }
      agent_whatsapp_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "agent_whatsapp_messages_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "agents"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "agent_whatsapp_messages_connection_id_fkey"
            columns: ["connection_id"]
            isOneToOne: false
            referencedRelation: "agent_whatsapp_connections"
            referencedColumns: ["id"]
