...
import { isValidMetaPhoneNumberId, normalizeDisplayPhone, normalizeWhatsappNumberForDb } from '@/utils/metaPhoneNumberValidation';
...
export const ClinicWhatsAppMappingForm: React.FC<Props> = ({ clinicId, defaultDisplayPhone }) => {
	...
	const handleSave = async () => {
		...
		try {
			...
			const whatsappNumber = normalizedDisplay ? normalizeWhatsappNumberForDb(normalizedDisplay) : null;
			...
			const msg = err?.message || 'Falha ao salvar mapeamento';
