...
import { Building2, Zap, Calendar } from 'lucide-react';
import { useClinic } from '@/contexts/ClinicContext';
import { useGoogleCalendar } from '@/hooks/useGoogleCalendar';
import { GoogleSessionStatus } from './GoogleSessionStatus';
...
export const WhatsAppIntegrationInfo = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Google Calendar Session Status Card */}
      <Card className="w-full">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Calendar className="h-5 w-5 text-blue-500" />
            Status da Sessão Google Calendar
          </CardTitle>
          <CardDescription>
            Monitoramento em tempo real da conexão com o Google Calendar
          </CardDescription>
        </CardHeader>
        <CardContent>
          <GoogleSessionStatus
