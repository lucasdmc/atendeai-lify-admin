-- ========================================
-- SPRINT 3 - TABELAS DE PERFORMANCE
-- ========================================
...
CREATE INDEX IF NOT EXISTS idx_ai_cache_clinic_timestamp ON ai_cache_entries(clinic_id, timestamp);
CREATE INDEX IF NOT EXISTS idx_ai_cache_user_timestamp ON ai_cache_entries(user_id, timestamp);
...
CREATE INDEX IF NOT EXISTS idx_streaming_clinic_timestamp ON ai_streaming_metrics(clinic_id, timestamp);
CREATE INDEX IF NOT EXISTS idx_streaming_user_timestamp ON ai_streaming_metrics(user_id, timestamp);
...
CREATE INDEX IF NOT EXISTS idx_interactions_clinic_timestamp ON ai_interactions(clinic_id, timestamp);
CREATE INDEX IF NOT EXISTS idx_interactions_user_timestamp ON ai_interactions(user_id, timestamp);
...
BEGIN
    ...
    SELECT 
        ...
        ace.tokens_used,
        ace.cost,
        ace.timestamp as created_timestamp,
