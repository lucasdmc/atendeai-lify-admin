-- Script para corrigir permissões do admin_lify
...
-- 2. Garantir que o usuário lucasdmc@lify.com tem role admin_lify
UPDATE user_profiles 
SET role = 'admin_lify' 
WHERE id = (SELECT id FROM auth.users WHERE email = 'lucasdmc@lify.com');

-- 3. Se o usuário não existir, criar
...
-- 5. Inserir todas as permissões para admin_lify
