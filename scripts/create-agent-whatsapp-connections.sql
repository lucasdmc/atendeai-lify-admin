...
-- 7. Triggers para atualizar timestamps (idempotentes)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_trigger WHERE tgname = 'update_agent_whatsapp_connections_updated_at'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_trigger WHERE tgname = 'update_agent_whatsapp_conversations_updated_at'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_trigger WHERE tgname = 'update_agent_conversation_memory_updated_at'
  ) THEN
...
-- 11. Políticas RLS para agentes (idempotentes)

-- agent_whatsapp_connections
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Users can view agent whatsapp connections' AND tablename = 'agent_whatsapp_connections'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Users can insert agent whatsapp connections' AND tablename = 'agent_whatsapp_connections'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Users can update agent whatsapp connections' AND tablename = 'agent_whatsapp_connections'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Users can view agent whatsapp messages' AND tablename = 'agent_whatsapp_messages'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Users can insert agent whatsapp messages' AND tablename = 'agent_whatsapp_messages'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Users can view agent whatsapp conversations' AND tablename = 'agent_whatsapp_conversations'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Users can insert agent whatsapp conversations' AND tablename = 'agent_whatsapp_conversations'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Users can update agent whatsapp conversations' AND tablename = 'agent_whatsapp_conversations'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Users can view agent conversation memory' AND tablename = 'agent_conversation_memory'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Users can insert agent conversation memory' AND tablename = 'agent_conversation_memory'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Users can update agent conversation memory' AND tablename = 'agent_conversation_memory'
  ) THEN
