-- Script completo para corrigir permissões do Admin Lify
...
-- 2. Garantir que o usuário lucasdmc@lify.com seja admin_lify
UPDATE user_profiles 
SET role = 'admin_lify' 
WHERE email = 'lucasdmc@lify.com';

-- 3. Adicionar todas as permissões necessárias para admin_lify
...
-- 4. Garantir que o usuário lucasdmc@lify.com tenha todas as permissões
...
-- 6. Atualizar função handle_new_user para garantir que novos admin_lify tenham acesso total
...
-- 7. Criar função para atualizar permissões quando role mudar
...
-- 8. Criar trigger para atualizar permissões automaticamente
...
-- 9. Garantir que todos os usuários tenham acesso à clínica padrão
...
-- 10. Verificar se a clínica padrão existe
...
SELECT 'Permissões do admin_lify:' as check_type, 
       module_name, 
       can_access, 
       can_create, 
       can_delete 
