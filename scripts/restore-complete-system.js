...
async function restoreCompleteSystem() {
  console.log('🔧 Restaurando sistema completo...')
  ...
  try {
    ...
    // 4. Criar dados de exemplo para clínicas
    ...
    // 5. Criar dados de exemplo para usuários
    ...
    // 6. Criar dados de exemplo para conversas
    ...
    // 7. Criar dados de exemplo para mensagens
    ...
    // 8. Criar dados de exemplo para agendamentos
    ...
    const { data: appointments, error: appointmentsError } = await supabase
      ...
      .insert([
        ...
        },
        {
          ...
          clinic_id: clinics?.[0]?.id,
          appointment_date: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString(), // Depois de amanhã
