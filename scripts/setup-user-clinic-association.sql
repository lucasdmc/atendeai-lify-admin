-- Script para implementar associação de usuários a clínicas
...
-- 7. Associar todos os usuários existentes à clínica principal
-- Primeiro, atualizar user_profiles com clinic_id
UPDATE public.user_profiles 
SET clinic_id = '00000000-0000-0000-0000-000000000001'
WHERE clinic_id IS NULL 
AND role NOT IN ('admin_lify', 'suporte_lify');

-- 8. Inserir associações na tabela clinic_users
...
-- 9. Atualizar políticas RLS da tabela clinics para usar clinic_users
...
-- 10. Criar função para verificar se usuário é admin lify
...
-- 11. Criar função para verificar se usuário tem acesso global
...
SELECT 'Usuários e suas clínicas:' as check_type, 
       up.email,
       up.role,
