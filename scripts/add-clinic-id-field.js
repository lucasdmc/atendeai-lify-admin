...
async function addClinicIdField() {
  ...
  try {
    ...
    // Tentar buscar conversas com clinic_id para ver se o campo existe
    ...
    if (testError && testError.code === '42703') {
      ...
      console.log('');
      console.log('❌ Não é possível adicionar colunas via API do Supabase');
