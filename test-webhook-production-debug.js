// Teste que verifica se a clínica está sendo encontrada corretamente no webhook em produção
import fetch from 'node-fetch';

async function testWebhookProductionDebug() {
  try {
    console.log('🧪 Testando webhook em produção com debug...');
